...
#
wget -q -O /usr/local/bin/geosite.dat "https://raw.githubusercontent.com/jagoanneon01/njajal/main/grpc/geosite.dat"
wget -q -O /usr/local/bin/geoip.dat "https://raw.githubusercontent.com/jagoanneon01/njajal/main/grpc/geoip.dat"
