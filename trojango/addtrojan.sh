...
trojanwsnone="trojan://${uuid}@${domain}:8880?path=/Ronggolawe&encryption=none&type=ws#${user}"
trojanwss="trojan://${user}@${domain}:8880/?sni=none&type=ws&host=${domain}&path=/Ronggolawe&encryption=none"
